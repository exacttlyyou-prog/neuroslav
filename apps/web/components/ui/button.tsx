...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "glass-strong text-primary-foreground hover:bg-background/50 backdrop-blur-sm",
        destructive:
          "bg-destructive/90 text-destructive-foreground hover:bg-destructive backdrop-blur-sm",
        outline:
          "border border-border/50 glass hover:glass-strong hover:text-accent-foreground",
        secondary:
          "glass text-secondary-foreground hover:glass-strong",
