"""
Alembic environment configuration for Digital Twin database migrations.
"""
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        compare_type=True,  # Сравнивает типы столбцов
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            transaction_per_migration=True,  # Каждая миграция в отдельной транзакции
        )
