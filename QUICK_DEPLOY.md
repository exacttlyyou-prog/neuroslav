...
## Вариант 1: Деплой через сайт (рекомендуется)

1. Зайди на [vercel.com](https://vercel.com) и войди
2. **Add New...** → **Project**
3. Подключи GitHub репозиторий `exacttlyyou-prog/neuroslav`
4. Нажми **Deploy**

## Вариант 2: Деплой через терминал
